...
function Cart() {
  ...
  return (
    <div className="bg-white font-inter -mt-[40vh]">
      <div className="">
      <div className="flex flex-col px-20">
        <h1 className="text-[28px] md:text-[32px] font-bold -mt-[15vh]">Shopping Cart</h1>
      ...
      <div className="flex justify-around gap-x-3 py-3">
        ...
        <div className="bg-[#F08000] text-center text-white  p-3 cursor-pointer" onClick={() => navigate("/checkout")}>Checkout</div>
      </div>
    </div>
  );
}
